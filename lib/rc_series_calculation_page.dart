...
class _RCCalculationPageState extends State<RCCalculationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('RC Time Domain Analysis')),
              ...
              buildContentContainer(
                content: [
                  ...
                  centering(
                    content: [
                      Math.tex(
                        'I(t) = I_C(t) = C \\cdot \\frac{dV_C(dt)}{dt}',
                        mathStyle: MathStyle.text,
                        textStyle: blueTextStyle, // Set the desired font size
                      ),
                      const SizedBox(height: 15),
                  ...
                  centering(
                    content: [
                      ...
                      const SizedBox(height: 15),
                      Math.tex(
                        '- ln|V - V_C(t)| = \\frac{t}{R\\cdot C} - ln|V|',
                        mathStyle: MathStyle.text,
                        textStyle: blueTextStyle, // Set the desired font size
                      ),
                      const SizedBox(height: 15),
                      Math.tex(
                        'ln|V - V_C(t)| - ln|V| = -\\frac{t}{R\\cdot C}',
                        mathStyle: MathStyle.text,
                        textStyle: blueTextStyle, // Set the desired font size
                      ),
                      const SizedBox(height: 15),
              ...
              buildContentContainer(
                content: [
                  ...
                  centering(
                    content: [
                      Math.tex(
                        '\\frac{dV_C(t)}{V_C(t)} = -\\frac{1}{R \\cdot C}',
                        mathStyle: MathStyle.text,
                  ...
                  centering(
                    content: [
                      Math.tex(
                        'ln|V_C(t)| = -\\frac{t}{R\\cdot C} + ln|V_0|',
                        mathStyle: MathStyle.text,
                        textStyle: blueTextStyle, // Set the desired font size
                      ),
                      const SizedBox(height: 15),
                      Math.tex(
                        'ln|V_C(t)| - ln|V_0| = - \\frac{t}{R\\cdot C}',
                        mathStyle: MathStyle.text,
                        textStyle: blueTextStyle, // Set the desired font size
                      ),
                      const SizedBox(height: 15),
                      Math.tex(
                        'ln|\\frac{V_C(t)}{V_0}| = -\\frac{t}{R\\cdot C}',
                        mathStyle: MathStyle.text,
                        textStyle: blueTextStyle, // Set the desired font size
                      ),
                      const SizedBox(height: 10),
...
*/
              ...
              // Step 4
              buildStepContainer(title: 'Step 4 : Find the Current'),
